...
<%
	...
	if(request.getParameter("user_id")==null||request.getParameter("user_pw")==null||request.getParameter("user_name")==null||request.getParameter("user_year")==""||request.getParameter("user_month")==""||request.getParameter("user_day")==""||request.getParameter("user_gender")==null||
	...
	UserDTO userDTO = new UserDTO(user_id,user_pw,user_name,user_year,user_month,user_day,user_gender,user_phone,user_email);
