	...
	<figure>
		...
		<div class="accordion" id="accordionExample">
			<div class="accordion-item">
				...
				<strong>내 회원 정보 확인 / 수정 / 탈퇴</strong>
				</button>
				</h2>
        					...
        					<form action="userUpdateAction.jsp" method="post">
								<table class="table table-bordered" style="text-align: center; vertical-align: middle;" >
									...
									<tr height="50">
										...
										<td width="300"  align="center">
											<input type="email" class="form-control" name="user_email" value="<%=user.getUser_email()%>">
										</td>
									</tr>
       						</table>
      					...
      					<div class="accordion-body">
      						<form action="accompanyUpdateAction.jsp" method="post">
								<table class="table table-bordered" style="text-align: center; vertical-align: middle;" >
									<tr height="50">
										<td width="100" align="center">코스(수정불가)</td>
										<td width="200" align="center">날짜(수정불가)</td>
									...
									<tr height="50">
										...
										<td width="200" align="center">										
											<input type="hidden" class="form-control" name="accompany_year" value="<%=accompanyDTO.getAccompany_year()%>"><%=accompanyDTO.getAccompany_year()%>년
											<input type="hidden" class="form-control" name="accompany_month" value="<%=accompanyDTO.getAccompany_month()%>"><%=accompanyDTO.getAccompany_month()%>월
											<input type="hidden" class="form-control" name="accompany_date" value="<%=accompanyDTO.getAccompany_date()%>"><%=accompanyDTO.getAccompany_date()%>일
